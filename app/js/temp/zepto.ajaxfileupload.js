$.extend($.fn, {
    ...
    createUploadForm: function (id, fileElementId, data) {
        ...
        if (data) {
            for (var i in data) {
                $('<textarea name="' + i + '" style="display:none;">'+data[i]+'</textarea>').appendTo(form);
            }
        }
        //Set attributes
    ...
    ajaxFileUpload: function (s) {
        ...
        var uploadCallback = function (isTimeout) {
            ...
            try {
                if (io.contentWindow) {
                    xml.responseText = io.contentWindow.document.body ? $('<div>').html(io.contentWindow.document.body.innerHTML).text(): null;
    ...
    uploadHttpData: function (r, type) {
        ...
        if (type == "html")
            $("<div>").html(data).find('script').remove();
        return data;
    },
