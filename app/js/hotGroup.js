...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = (function (_React$Component) {
	    ...
	    function Main() {
	        ...
	        _this.state = {
	            hotTagList: _immutable2.default.List(),
	    ...
	    _createClass(Main, [{
	        ...
	        key: 'initList',
	        value: function initList(trid, hotTagList) {
	            var _this3 = this;
	            ...
	            _superagent2.default.get(url).end(function (err, req) {
	                if (req.status === 200) {
	                    ...
	                    if (data.status.code === '0') {
	                        data = data.data;
	                        _this3.setState({
	                            list: _immutable2.default.List(data),
	                            hotTagList: !!hotTagList ? _immutable2.default.List(hotTagList) : _this3.state.hotTagList,
	                            trid: trid
	                        });
	                    } else {
	                        alert(data.status.msg);
	        ...
	        value: function eventToggleTab(e) {
	            ...
	            var hotTagList = this.state.hotTagList;
	            if (!!trid) {
	                this.initList(trid);
	                hotTagList = hotTagList.map(function (v, i) {
	                    if (i === Number(ix)) {
	                        v.active = 'active';
	                    } else {
	                        v.active = '';
	        ...
	        value: function scrollLoading() {
	            window.addEventListener('scroll', function (e) {
	                var VTop = document.body.scrollTop,
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'section',
	                    { id: 'hotGroup-list' },
	                    _react2.default.createElement(_groupList2.default, { data: this.state.list, trid: this.state.trid }),
	                    _react2.default.createElement(
	                        'div',
	                        { id: 'hotGroup-loading' },
	                        'eq'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Local = (function (_React$Component) {
		...
		function Local(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Local).call(this, props));
		...
		_createClass(Local, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ id: 'loading-body' },
					_react2.default.createElement('div', { id: 'loading-local', style: { backgroundImage: this.props.img } })
				);
			}
		}]);
	...
	var Loading = (function (_React$Component2) {
		...
		function Loading(props) {
			...
			console.log(_vars2.default.path('staticPath'));

			_this2.state = {
				imgLoading: 'url(' + _vars2.default.path('staticPath') + 'img/f110.png)'
			};
			return _this2;
		}
		...
		_createClass(Loading, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(Local, { img: this.state.imgLoading })
				// {local}
				;
			}
		}]);
