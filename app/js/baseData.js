	...
	var HeadImg = (function (_React$Component) {
		...
		_createClass(HeadImg, [{
			...
			value: function imgChange(e) {
				...
				var sharekey = this.state.vars['sharekey'];
					...
					if (window.FileReader) {
						(function () {
							var reader = new FileReader(),
							    ...
							    mid = _storage2.default.get('ws')['mid'],
							    key = name + _md2.default.init(name + sharekey),
							    url = undefined;
							...
							reader.onload = function (e1) {
								...
								url = _formatAjax2.default.get(_vars2.default.api('fileUpload'), {
									key: key,
									type: 6,
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', { id: 'file', name: 'file', type: 'file', multiple: 'multiple', accept: 'image/jpg,image/png,image/jpeg',
	...
	var Main = (function (_React$Component2) {
		...
		_createClass(Main, [{
			...
			value: function nexts() {
				var url = '',
				    mid = _storage2.default.get('ws')['mid'],
				    user = mid + _md2.default.init(mid + this.state.vars['sharekey']),
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('input', { id: 'nickName', type: 'text', placeholder: this.state.nick.placeholder, value: this.state.nick.name, onChange: function onChange(e) {
									_this6.nickChange(e);
								} })
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'select',
								{ id: 'gender', onChange: function onChange(e) {
										_this6.sexChange(e);
									} },
								_react2.default.createElement(
									'option',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'select',
								{ id: 'address', onChange: function onChange(e) {
										_this6.cityChange(e);
									} },
								cityList
							)
...
/***/ function(module, exports) {
	...
	jQuery.extend({
	    ...
	    createUploadForm: function createUploadForm(id, fileElementId, data) {
	        ...
	        var form = jQuery('<form  action="" method="PUT" name="' + formId + '" id="' + formId + '" enctype="multipart/form-data"></form>');
	        //Handle files
	    ...
	    uploadHttpData: function uploadHttpData(r, type) {
	        ...
	        if (type == "html") jQuery("<div>").html(data).find('script').remove();
	        return data;
	    },
