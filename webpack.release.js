...
module.exports = {
    ...
    plugins: [
        ...
        //     entry: './app/html/starResult.html',
        //     hash: '[chunkhash]',
        //     output: './app/html/build/starResult.html',
        //     data: {
        //         js: '<script src=./js/starResult.js"></script>'
        //     }
        // }),
        ...
        new HtmlWebpackPlugin(
            {
                filename: '../html/starResult.html',
                template: './app/html/starResult.html', // 原始模块
        ...
        // new HtmlWebpackPlugin(
        //     {
        //         filename: '../html/fansGroup.html',
        //         template: './app/html/fansGroup.html', // 原始模块
        //         inject: 'body', // 放在body中  & eq: 'head'  放在head中
        //         chunks: ['index']
        //     }
        // ),
        new CopyWebpackPlugin([
            { from: './app/html/build/', to: '../html'},
            // { from: './app/img/', to: '../img/' },
